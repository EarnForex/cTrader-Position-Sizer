...
{
    public IEnumerable<Position> PositionsByLabel { get; }
    Symbol Symbol { get; }
    double Bid { get; }
    double Ask { get; }
...
public class TrailingStop : IRiskManager, ITrailingStopResources
{
    ...
    public void Check()
    {
        foreach (var pos in PositionsByLabel)
        {
    ...
    public IEnumerable<Position> PositionsByLabel => _resources.PositionsByLabel;
