...
public partial class PositionSizer
{
    ...
    public void StartPresenter()
    {
        ...
        SetupWindowView.RiskView.IncludeOrdersModeChanged += RiskViewOnIncludeOrdersModeChanged;
        SetupWindowView.RiskView.IncludeSymbolsModeChanged += RiskViewOnIncludeSymbolsModeChanged;
        SetupWindowView.RiskView.IncludeDirectionsModeChanged += RiskViewOnIncludeDirectionsModeChanged;
    ...
    private void SubscribeToTradingViewEvents()
    {
        ...
        SetupWindowView.TradingView.MaxRiskPercentageValueChanged += TradingViewOnMaxRiskPercentageValueChanged;
