    ...
    //IKeyMultiplierFeature
{
    ...
    public IEnumerable<Position> PositionsByLabelAndComment =>
        Positions.Where(p => p.Label == Model.Label && p.Comment == Model.Comment);

    public IEnumerable<PendingOrder> PendingOrdersByLabelAndComment =>
        PendingOrders.Where(p => p.Label == Model.Label && p.Comment == Model.Comment);
    ...
    private void Initialize()
    {
        ...
        //For Risk Model
        Model.CountPendingOrders = canImplementModel && !_changedProperties.Contains("InputCountPendingOrders")
            ? storageModel.CountPendingOrders
            : InputCountPendingOrders;
        ...
        Model.IgnoreOrdersInOtherSymbols = canImplementModel && !_changedProperties.Contains("InputIgnoreOtherSymbols")
            ? storageModel.IgnoreOrdersInOtherSymbols
            : InputIgnoreOtherSymbols;
    ...
    {
        IndexForLabelReference = InputIndexTest;
    }
