...
public partial class PositionSizer
{
    ...
    private void TradingViewOnMaxRiskPercentageValueChanged(object sender, MaxRiskPercentageValueChangedEventArgs e)
    {
        Model.MaxRiskPercentage = e.MaxRiskPercentage;
