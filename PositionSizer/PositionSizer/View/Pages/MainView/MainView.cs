...
public class MainView : Button, IMainViewResources
{
    ...
    private readonly CheckBox _lockTpCheckBox;
    ...
    public MainView(IMainViewResources resources, IModel model)
    {
        ...
        if (InputLongButtonColor != Color.Transparent)
        ...
        _lockTpCheckBox = MakeCheckBox("Lock TP");
    ...
    public void ChangeDirection()
    {
        if (_longShortButton.Text == "Long")
        {
            ...
            if (InputShortButtonColor != Color.Transparent)
                _longShortButton.BackgroundColor = InputShortButtonColor;
