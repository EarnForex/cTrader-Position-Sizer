...
public class RiskView : Button, IRiskViewResources
{
    ...
    private readonly Button _includeOrdersModeButton;
    private readonly Button _includeSymbolsModeButton;
    private readonly Button _includeDirectionsModeButton;
    ...
    public event EventHandler IncludeOrdersModeChanged;
    public event EventHandler IncludeSymbolsModeChanged;
    public event EventHandler IncludeDirectionsModeChanged;
    
    private const int ButtonsWidth = 85;
    private const int ButtonsHeight = 25;

    public RiskView(IRiskViewResources resources, IModel model)
    {
        ...
        var includeOrderTextBlock = MakeTextBlock("Include Orders");
        _includeOrdersModeButton = MakeButton(BotTools.GetDescription(model.IncludeOrdersMode));
        _includeOrdersModeButton.Width = ButtonsWidth;
        _includeOrdersModeButton.Height = ButtonsHeight;
        _includeOrdersModeButton.Click += IncludeOrdersModeButtonOnClick;
        
        _grid.AddChild(includeOrderTextBlock, row, 0, 1, 1);
        _grid.AddChild(_includeOrdersModeButton, row++, 1, 1, 1);
        ...
        var includeSymbolsTextBlock = MakeTextBlock("Include Symbols");
        _includeSymbolsModeButton = MakeButton(BotTools.GetDescription(model.IncludeSymbolsMode));
        _includeSymbolsModeButton.Width = ButtonsWidth;
        _includeSymbolsModeButton.Height = ButtonsHeight;
        _includeSymbolsModeButton.Click += IncludeSymbolsModeButtonOnClick;
        
        _grid.AddChild(includeSymbolsTextBlock, row, 0, 1, 1);
        _grid.AddChild(_includeSymbolsModeButton, row++, 1, 1, 1);
        
        var includeDirectionsTextBlock = MakeTextBlock("Include");
        _includeDirectionsModeButton = MakeButton(BotTools.GetDescription(model.IncludeDirectionsMode));
        _includeDirectionsModeButton.Width = ButtonsWidth;
        _includeDirectionsModeButton.Height = ButtonsHeight;
        _includeDirectionsModeButton.Click += IncludeDirectionsModeButtonOnClick;
        
        _grid.AddChild(includeDirectionsTextBlock, row, 0, 1, 1);
        _grid.AddChild(_includeDirectionsModeButton, row++, 1, 1, 1);
    ...
    private void IncludeDirectionsModeButtonOnClick(ButtonClickEventArgs obj)
    {
        IncludeDirectionsModeChanged?.Invoke(this, EventArgs.Empty);
    }

    private void IncludeSymbolsModeButtonOnClick(ButtonClickEventArgs obj)
    {
        IncludeSymbolsModeChanged?.Invoke(this, EventArgs.Empty);
    }

    private void IncludeOrdersModeButtonOnClick(ButtonClickEventArgs obj)
    {
        IncludeOrdersModeChanged?.Invoke(this, EventArgs.Empty);
    }

    public void Update(IModel model)
    {
        _includeOrdersModeButton.Text = BotTools.GetDescription(model.IncludeOrdersMode);
        ...
        _includeSymbolsModeButton.Text = BotTools.GetDescription(model.IncludeSymbolsMode);
        _includeDirectionsModeButton.Text = BotTools.GetDescription(model.IncludeDirectionsMode);
    ...
    private CheckBox MakeCheckBox(string text) =>
        ...
        {
            Text = text,
            Style = _resources.CustomStyle.CheckBoxStyle,
